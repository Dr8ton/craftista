...
docker run -d -p 8080:8080 -e CATALOGUE_SERVICE_URL="http://${aws_instance.catalogue.private_ip}:5000/api/products" --restart unless-stopped dr8ton/craftista-voting
EOT
